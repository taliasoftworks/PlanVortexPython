...
class AppsResource(Resource):
    ...
    def rotate_secret(self, id_client: str, id_app: str, *, timeout: float | None = None) -> str:
        ...
        **The previous secret stops working the moment this answers**, with no grace period: anything
        ...
        not after.
        """
        cuerpo: dict[str, str] = self._post(f"{self._one_path(id_client, id_app)}/secret", timeout=timeout)
        return cuerpo["secret"]
