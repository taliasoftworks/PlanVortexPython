...
Gemelo sincrono de `src/planvortex/resources/publications.py`.
...
class PublicationsResource(Resource):
    ...
    def create(
        ...
        **On Pinterest the board is REQUIRED**, and leaving it out does not raise here: without
        ...
        .. code-block:: python
            ...
            board = (pv.accounts.destinations(org_id, pinterest_id))[0]
        ...
        """
        publicacion: Publication = self._post_one(
    ...
    def get(self, id_organization: str, id_publication: str, *, timeout: float | None = None) -> Publication:
        ...
        """
        publicacion: Publication = self._one(
    ...
    def list(
        ...
        *,
        ...
        """
        pagina: Page[Publication] = self._list(
    ...
    def iterate(
        ...
        *,
        ...
        def buscar(params: PageParams) -> Page[Publication]:
            return self.list(
                id_organization,
                limit=params.limit,
    ...
    def update(
        ...
        *,
        ...
        """
        publicacion: Publication = self._put_one(
    ...
    def update_by_account(
        ...
        *,
        ...
        publicacion: Publication = self._put_one(ruta, "publication", _serialize(body), timeout=timeout)
        return publicacion

    def remove(self, id_organization: str, id_publication: str, *, timeout: float | None = None) -> None:
        ...
        **On Telegram there is a 48-hour window.** Past it the Bot API refuses to delete the message
        ...
        second :meth:`remove`.
        """
        self._delete(self._path(id_organization, id_publication), timeout=timeout)
    ...
    def retry(
        ...
        """
        reintento: PublicationRetryResult = self._post(
    ...
    def metrics(
        ...
        **On X this costs one credit per read.** To paint a chart use :meth:`stats`, which reads what
        ...
        """
        metricas: PublicationStats = self._get(
    ...
    def stats(
        ...
        """
        historico: PublicationStatsHistory = self._get(
